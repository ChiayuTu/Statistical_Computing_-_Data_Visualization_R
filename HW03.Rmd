...
1. Identify and list the *primary and foreign keys* for each data frame.
  ...
  Table "policytrackerCA"
    primary keys: N/A
    foreign keys: date 
  Table "covid.usa.ts.confirmed"
    primary keys: UID
    foreign keys: Province_State and Combined_Key
  Table "covid.usa.ts.deaths"
    primary keys: UID
    foreign keys: Province_State and Combined_Key
  Table "covid.usa.daily"
    primary keys: Province_State
    foregin keys: 
  Table "vacc.people"
    primary keys: Date 
    foreign keys: Province_State
...
```{r Part Two Task One, echo=FALSE}
...
```{r Part Two Task Two, echo=FALSE}
...
```{r Part Two Task Three, echo=FALSE}
...
```{r Part Two Task Four, echo=FALSE}
...
```{r Part Two Task Five, echo=FALSE}
